...
### 9.4 A2 MegaMoe Reproduction and Acceptance

See [A2 MegaMoe reproduction and tests](../../developer_guide/performance_and_debug/megamoe_a2_reproduction.md) for the validated source and runtime versions, operator correctness and ABBA measurements, and controlled model enabled/disabled acceptance. The guide specifies input data, warmups, repetitions, success criteria, and the scope of the reported gains.
